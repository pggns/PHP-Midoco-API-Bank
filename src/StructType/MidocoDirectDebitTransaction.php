...
class MidocoDirectDebitTransaction extends DtausTransactionDTO
{
     ...
     */
    public function __construct(?string $errorDescription = null, ?string $transactionType = null, array $midocoDirectDebitTransactionPurpose = [], ?\Pggns\MidocoApi\Bank\StructType\MidocoDtazvTransactionInfo $midocoDtazvTransactionInfo = null)
    {
        $this
