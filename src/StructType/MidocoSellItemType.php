...
class MidocoSellItemType extends SellItemDTO
{
     ...
     */
    public function __construct(array $midocoPriceDetail = [], array $midocoOnlinePaymentTransaction = [], array $midocoSellPassenger = [], array $midocoSellRemark = [], ?\Pggns\MidocoApi\Bank\StructType\MidocoDocumentItem $midocoDocumentItem = null, ?\Pggns\MidocoApi\Bank\StructType\MidocoTravelItemType $midocoTravelItem = null, ?\Pggns\MidocoApi\Bank\StructType\ManualitemDTO $midocoManualItem = null, ?\Pggns\MidocoApi\Bank\StructType\CalcitemDTO $midocoCalcItem = null, ?\Pggns\MidocoApi\Bank\StructType\PackageitemDTO $midocoPackageInfo = null, ?\Pggns\MidocoApi\Bank\StructType\MidocoSellItemPricing $midocoSellItemPricing = null, array $midocoSellItemError = [], array $midocoSellItem = [], array $revenueBookingInfo = [], array $midocoSellItemAttribute = [], array $midocoSellItemVatDivision = [], array $midocoSellDetailsPrice = [], ?\Pggns\MidocoApi\Bank\StructType\SellItemItemDTO $midocoSellItemItem = null, array $midocoSellItemSaving = [], ?\Pggns\MidocoApi\Bank\StructType\SellItemEinvoiceDTO $midocoSellItemEinvoice = null, ?\Pggns\MidocoApi\Bank\StructType\EnrichmentCreditCardDTO $midocoEnrichmentCreditCard = null, ?\Pggns\MidocoApi\Bank\StructType\MidocoMilesAndMoreEarnInfoType $midocoMilesAndMoreEarnInfo = null, array $midocoOrderNotice = [], ?string $unitAlias = null, ?bool $isPackageChild = null, ?int $billingStatus = null, ?int $incomingInvoiceStatus = null, ?bool $is_deletable = null, ?float $displayedItemPrice = null, ?string $displayedCurrency = null)
    {
        $this
