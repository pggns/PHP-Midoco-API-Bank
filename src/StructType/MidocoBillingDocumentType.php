...
class MidocoBillingDocumentType extends BillingDocumentDTO
{
     ...
     */
    public function __construct(array $midocoBillingRemark = [], ?\Pggns\MidocoApi\Bank\StructType\BillingAttributeDTO $midocoBillingAttribute = null, array $midocoBillingVatCalculation = [], array $midocoBillingPosition = [], ?\Pggns\MidocoApi\Bank\StructType\MidocoBillingOnlinePayment $midocoBillingOnlinePayment = null, ?\Pggns\MidocoApi\Bank\StructType\BillingAdvisedPaymentDTO $midocoBillingAdvisedPayment = null, array $midocoOrderBilling = [], array $midocoBillingPrint = [], ?\Pggns\MidocoApi\Bank\StructType\MidocoEinvoiceDocument $midocoEinvoiceDocument = null, ?\Pggns\MidocoApi\Bank\StructType\MidocoBillingEinvoice $midocoBillingEinvoice = null, ?\Pggns\MidocoApi\Bank\StructType\CollectInvSettingDTO $midocoCollectiveInvoiceSetting = null, ?string $unitAlias = null, ?int $dbiStatus = null, ?int $cancellationDocNo = null, ?string $confirmationGroup = null, ?string $storeUntil = null, ?bool $isDraft = false, ?string $bulkItemTypeSetting = null, ?string $bulkCostCentreSetting = null, ?string $bulkUserSplitSetting = null, ?string $bulkDepartureDateSetting = null)
    {
        $this
