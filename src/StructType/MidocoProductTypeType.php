...
class MidocoProductTypeType extends ProductTypeDTO
{
     ...
     */
    public function __construct(array $midocoProductTypeMediatorCondition = [], array $midocoProductTypeSupplier = [], ?\Pggns\MidocoApi\Bank\StructType\VatDivisionTemplateType $vatDivisionIn = null, ?\Pggns\MidocoApi\Bank\StructType\VatDivisionTemplateType $vatDivisionOut = null)
    {
        $this
