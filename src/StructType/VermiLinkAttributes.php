...
class VermiLinkAttributes extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\MidocoOrderCustomer $midocoOrderCustomer = null, array $midocoSellPassenger = [], array $serviceCode = [], ?int $orderId = null, ?int $orderNo = null, ?int $itemId = null, ?int $midocoUserId = null, ?string $midocoUserName = null, ?string $mediator = null, ?string $extSystem = null, ?string $extId = null, ?string $supplierId = null, ?string $bookingId = null, ?string $startTravel = null, ?string $endTravel = null, ?string $countryCode = null, ?string $countryDesc = null, ?float $itemPrice = null)
    {
        $this
