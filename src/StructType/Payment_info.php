...
class Payment_info extends AbstractStructBase
{
     ...
     */
    public function __construct(array $cc_payment = [], ?\Pggns\MidocoApi\Bank\StructType\Debit_payment $debit_payment = null, ?\Pggns\MidocoApi\Bank\StructType\Advised_payment $advised_payment = null, ?string $preferred_payment_type = null)
    {
        $this
