...
class MidocoCustomerMf extends CustomerMfDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\CustomerMfAllowedValueDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\CustomerMfAllowedValueDTO[] $midocoCustomerMfAllowedValue
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\CustomerMfAllowedValueDTO[]
     */
    ...
    public static function validateMidocoCustomerMfAllowedValueForArrayConstraintFromSetMidocoCustomerMfAllowedValue(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerMfMidocoCustomerMfAllowedValueItem) {
            ...
            if (!$midocoCustomerMfMidocoCustomerMfAllowedValueItem instanceof \Pggns\MidocoApi\Bank\StructType\CustomerMfAllowedValueDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCustomerMfAllowedValue property can only contain items of type \Pggns\MidocoApi\Bank\StructType\CustomerMfAllowedValueDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\CustomerMfAllowedValueDTO[] $midocoCustomerMfAllowedValue
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCustomerMf
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\CustomerMfAllowedValueDTO $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoCustomerMf
     */
    public function addToMidocoCustomerMfAllowedValue(\Pggns\MidocoApi\Bank\StructType\CustomerMfAllowedValueDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\CustomerMfAllowedValueDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCustomerMfAllowedValue property can only contain items of type \Pggns\MidocoApi\Bank\StructType\CustomerMfAllowedValueDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
