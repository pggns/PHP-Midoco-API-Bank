...
class MidocoItemSellingModeType extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Bank\StructType\ISectionFieldType|null
     */
    protected ?\Pggns\MidocoApi\Bank\StructType\ISectionFieldType $abtaSection = null;
    /**
     * The atolClassificationType
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Bank\StructType\IAtolClassType|null
     */
    protected ?\Pggns\MidocoApi\Bank\StructType\IAtolClassType $atolClassificationType = null;
    /**
     * The abtaClassificationType
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Bank\StructType\IAbtaClassType|null
     */
    protected ?\Pggns\MidocoApi\Bank\StructType\IAbtaClassType $abtaClassificationType = null;
    /**
     * The itemId
     * @var int|null
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\ISectionFieldType $abtaSection
     * @param \Pggns\MidocoApi\Bank\StructType\IAtolClassType $atolClassificationType
     * @param \Pggns\MidocoApi\Bank\StructType\IAbtaClassType $abtaClassificationType
     * @param int $itemId
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\ISectionFieldType $abtaSection = null, ?\Pggns\MidocoApi\Bank\StructType\IAtolClassType $atolClassificationType = null, ?\Pggns\MidocoApi\Bank\StructType\IAbtaClassType $abtaClassificationType = null, ?int $itemId = null, ?string $itemType = null, ?string $supplierId = null, ?string $bookingId = null, ?string $startTravel = null, ?string $endTravel = null, ?string $status = null, ?float $price = null, ?int $sellingMode = null, ?string $confirmationGroup = null, ?int $atolIndex = null, ?string $atolPeriod = null, ?string $sellingModeDetermination = null)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\ISectionFieldType|null
     */
    public function getAbtaSection(): ?\Pggns\MidocoApi\Bank\StructType\ISectionFieldType
    {
     ...
     */
    public function setAbtaSection(?\Pggns\MidocoApi\Bank\StructType\ISectionFieldType $abtaSection = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\IAtolClassType|null
     */
    public function getAtolClassificationType(): ?\Pggns\MidocoApi\Bank\StructType\IAtolClassType
    {
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoItemSellingModeType
     */
    public function setAtolClassificationType(?\Pggns\MidocoApi\Bank\StructType\IAtolClassType $atolClassificationType = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\IAbtaClassType|null
     */
    public function getAbtaClassificationType(): ?\Pggns\MidocoApi\Bank\StructType\IAbtaClassType
    {
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoItemSellingModeType
     */
    public function setAbtaClassificationType(?\Pggns\MidocoApi\Bank\StructType\IAbtaClassType $abtaClassificationType = null): self
    {
