...
class Midoco_booking_message extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\Agency_identity $agency_identity = null, array $customer = [], array $package_info = [], array $booking = [], ?\Pggns\MidocoApi\Bank\StructType\Prices $prices = null, array $ticket = [], ?\Pggns\MidocoApi\Bank\StructType\Payment_info $payment_info = null, ?\Pggns\MidocoApi\Bank\StructType\Marketing_info $marketing_info = null, ?\Pggns\MidocoApi\Bank\StructType\Internal_treatment $internal_treatment = null, array $order_remark = [], array $externalPayment = [], array $imported_document = [], array $dunningInfo = [], array $voucher = [], array $verk_data = [], ?int $message_version = 1)
    {
        $this
