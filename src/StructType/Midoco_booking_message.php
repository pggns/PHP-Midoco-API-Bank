...
class Midoco_booking_message extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Bank\StructType\Internal_command_configuration[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Bank\StructType\Cdf[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\Internal_command_configuration[] $internal_command_configuration
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\Cdf[] $customerDefinedField
     * @param int $message_version
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\Agency_identity $agency_identity = null, ?array $customer = null, ?array $package_info = null, ?array $booking = null, ?\Pggns\MidocoApi\Bank\StructType\Prices $prices = null, ?array $ticket = null, ?\Pggns\MidocoApi\Bank\StructType\Payment_info $payment_info = null, ?\Pggns\MidocoApi\Bank\StructType\Marketing_info $marketing_info = null, ?\Pggns\MidocoApi\Bank\StructType\Internal_treatment $internal_treatment = null, ?array $internal_command_configuration = null, ?array $order_remark = null, ?array $externalPayment = null, ?array $imported_document = null, ?array $dunningInfo = null, ?array $voucher = null, ?array $verk_data = null, ?array $customerDefinedField = null, ?int $message_version = 1)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\Internal_command_configuration[]
     */
    ...
    public static function validateInternal_command_configurationForArrayConstraintFromSetInternal_command_configuration(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messageInternal_command_configurationItem) {
            // validation for constraint: itemType
            if (!$midoco_booking_messageInternal_command_configurationItem instanceof \Pggns\MidocoApi\Bank\StructType\Internal_command_configuration) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The internal_command_configuration property can only contain items of type \Pggns\MidocoApi\Bank\StructType\Internal_command_configuration, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\Internal_command_configuration $item
     * @return \Pggns\MidocoApi\Bank\StructType\Midoco_booking_message
     */
    public function addToInternal_command_configuration(\Pggns\MidocoApi\Bank\StructType\Internal_command_configuration $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\Internal_command_configuration) {
            throw new InvalidArgumentException(sprintf('The internal_command_configuration property can only contain items of type \Pggns\MidocoApi\Bank\StructType\Internal_command_configuration, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\Cdf[]
     */
    ...
    public static function validateCustomerDefinedFieldForArrayConstraintFromSetCustomerDefinedField(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messageCustomerDefinedFieldItem) {
            // validation for constraint: itemType
            if (!$midoco_booking_messageCustomerDefinedFieldItem instanceof \Pggns\MidocoApi\Bank\StructType\Cdf) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The CustomerDefinedField property can only contain items of type \Pggns\MidocoApi\Bank\StructType\Cdf, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\Cdf $item
     * @return \Pggns\MidocoApi\Bank\StructType\Midoco_booking_message
     */
    public function addToCustomerDefinedField(\Pggns\MidocoApi\Bank\StructType\Cdf $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\Cdf) {
            throw new InvalidArgumentException(sprintf('The CustomerDefinedField property can only contain items of type \Pggns\MidocoApi\Bank\StructType\Cdf, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
