...
class GetAccountPlan4OrgUnitResponse extends AbstractStructBase
{
     ...
     */
    protected array $MidocoAccountInfo = [];
    /**
     ...
     */
    public function __construct(array $midocoAccountInfo = [])
    {
        $this
    ...
    /**
     * This method is responsible for validating the values passed to the setMidocoAccountInfo method
     ...
     */
    public static function validateMidocoAccountInfoForArrayConstraintsFromSetMidocoAccountInfo(array $values = []): string
    {
        $message = '';
        $invalidValues = [];
     ...
     */
    public function setMidocoAccountInfo(array $midocoAccountInfo = []): self
    {
        // validation for constraint: array
        if ('' !== ($midocoAccountInfoArrayErrorMessage = self::validateMidocoAccountInfoForArrayConstraintsFromSetMidocoAccountInfo($midocoAccountInfo))) {
