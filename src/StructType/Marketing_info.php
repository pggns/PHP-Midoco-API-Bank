...
class Marketing_info extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $area_code = null, ?string $travel_duration = null, ?string $season = null, ?string $travel_type = null, ?string $transportation = null, ?string $person_count = null, ?\Pggns\MidocoApi\Bank\StructType\Search_criteria $search_criteria = null, array $attribute = [])
    {
        $this
