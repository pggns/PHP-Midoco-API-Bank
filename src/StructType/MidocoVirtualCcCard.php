...
class MidocoVirtualCcCard extends VirtualCreditCardDTO
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcCardAccount|null
     */
    protected ?\Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcCardAccount $MidocoVirtualCcCardAccount = null;
    /**
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcMetaData[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcCardAccount $midocoVirtualCcCardAccount
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcMetaData[] $midocoVirtualCcMetaData
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcCardAccount $midocoVirtualCcCardAccount = null, ?array $midocoVirtualCcMetaData = null)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcCardAccount|null
     */
    public function getMidocoVirtualCcCardAccount(): ?\Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcCardAccount
    {
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcCardAccount $midocoVirtualCcCardAccount
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcCard
     */
    public function setMidocoVirtualCcCardAccount(?\Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcCardAccount $midocoVirtualCcCardAccount = null): self
    {
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcMetaData[]
     */
    ...
    public static function validateMidocoVirtualCcMetaDataForArrayConstraintFromSetMidocoVirtualCcMetaData(?array $values = []): string
    {
        ...
        foreach ($values as $midocoVirtualCcCardMidocoVirtualCcMetaDataItem) {
            ...
            if (!$midocoVirtualCcCardMidocoVirtualCcMetaDataItem instanceof \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcMetaData) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoVirtualCcMetaData property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcMetaData, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcMetaData $item
     * @return \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcCard
     */
    public function addToMidocoVirtualCcMetaData(\Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcMetaData $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcMetaData) {
            throw new InvalidArgumentException(sprintf('The MidocoVirtualCcMetaData property can only contain items of type \Pggns\MidocoApi\Bank\StructType\MidocoVirtualCcMetaData, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
