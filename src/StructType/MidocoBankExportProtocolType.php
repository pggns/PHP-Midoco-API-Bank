...
class MidocoBankExportProtocolType extends AbstractStructBase
{
     ...
     */
    public function __construct(array $midocoBankBookingJournal = [], ?string $errorCode = null, ?string $errorBundle = null, ?string $errorArgs = null, ?string $pageNo = null, ?string $statementNo = null, ?string $bookingDate = null, ?string $infoName1 = null)
    {
        $this
