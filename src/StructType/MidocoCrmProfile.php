...
class MidocoCrmProfile extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\CrmCustomerDTO $midocoCrmCustomer = null, array $externalProfile = [], ?\Pggns\MidocoApi\Bank\StructType\ProfileAttributes $profileAttributes = null, array $midocoCrmCustomerLink = [], array $midocoFrequentFlyerNumber = [], array $midocoCrmAddress = [], array $midocoContactEntry = [])
    {
        $this
