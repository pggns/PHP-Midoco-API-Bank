...
class MidocoOrderType extends OrderDTO
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Bank\StructType\MidocoOnlinePayment $midocoOnlinePayment = null, ?\Pggns\MidocoApi\Bank\StructType\AdvisedPaymentDTO $midocoAdvisedPayment = null, ?\Pggns\MidocoApi\Bank\StructType\MidocoDebitPayment $midocoDebitPayment = null, array $midocoSellItem = [], array $midocoOrderCustomer = [], array $midocoOrdersDbiInfo = [], array $externalPayment = [], array $midocoOrderNotice = [], ?float $calculatedMarginServices = null, ?string $unitAlias = null, ?string $mediatorPortal = null, ?bool $isModified = null, ?string $preferredPaymentType = null, ?string $paymentTypeInfo = null, ?bool $existTravelPlans = null, ?bool $existOrderDocuments = null, ?bool $existOrderNotices = null, ?bool $existOrderRemarks = null, ?bool $existPaymentPaycodes = null, ?bool $existOrderBillings = null)
    {
        $this
