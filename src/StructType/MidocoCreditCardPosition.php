...
class MidocoCreditCardPosition extends MidocoOnlinePaymentTransactionPosition
{
     ...
     */
    public function __construct(?string $ccType = null, ?string $ccNo = null, ?string $ccCvc = null, ?string $ccValidYear = null, ?string $ccValidMonth = null, ?string $ccOwner = null, ?string $ccAuthCode = null, ?\Pggns\MidocoApi\Bank\StructType\MidocoPaymentOrdersInfos $midocoPaymentOrdersInfos = null, array $midocoCcToken = [], ?string $ccToken = null, ?string $ccTokenType = null, ?bool $isRecurring = null, ?int $preferredReceiptId = null)
    {
        $this
            ->setCcType($ccType)
            ->setCcNo($ccNo)
