...
class CustAddrDebitorPayment extends AbstractStructBase
{
     ...
     * @param int $custOrder
     */
    public function __construct(array $midocoCrmAddress = [], array $midocoDebitor = [], ?\Pggns\MidocoApi\Bank\StructType\CrmCustomerPaymentDTO $midocoCustomerPayment = null, array $midocoContactEntry = [], array $midocoCrmCcCard = [], array $midocoCrmDebitCard = [], array $midocoCrmBonusCard = [], array $midocoCrmCriteria = [], ?\Pggns\MidocoApi\Bank\StructType\CrmCustomerDTO $midocoCrmCustomer = null, ?int $custOrder = null)
    {
        $this
