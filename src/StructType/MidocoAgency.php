...
class MidocoAgency extends AgencyDetailDTO
{
     ...
     */
    public function __construct(array $midocoAgencyCommission = [], ?\Pggns\MidocoApi\Bank\StructType\CrmCustomerDTO $midocoCrmCustomer = null, ?\Pggns\MidocoApi\Bank\StructType\MidocoCrmCustomerPayment $midocoCrmCustomerPayment = null, ?string $cooperationName = null)
    {
        $this
