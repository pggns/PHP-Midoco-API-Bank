...
class UserDataSaveGUIPropertiesRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\UserDataGUIProperty[]
     */
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\UserDataGUIProperty[] $userDataGUIProperty
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\UserDataGUIProperty[]
     */
    ...
    public static function validateUserDataGUIPropertyForArrayConstraintFromSetUserDataGUIProperty(?array $values = []): string
    {
        ...
        foreach ($values as $userDataSaveGUIPropertiesRequestUserDataGUIPropertyItem) {
            ...
            if (!$userDataSaveGUIPropertiesRequestUserDataGUIPropertyItem instanceof \Pggns\MidocoApi\Bank\StructType\UserDataGUIProperty) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The UserDataGUIProperty property can only contain items of type \Pggns\MidocoApi\Bank\StructType\UserDataGUIProperty, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Bank\StructType\UserDataGUIProperty[] $userDataGUIProperty
     * @return \Pggns\MidocoApi\Bank\StructType\UserDataSaveGUIPropertiesRequest
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\UserDataGUIProperty $item
     * @return \Pggns\MidocoApi\Bank\StructType\UserDataSaveGUIPropertiesRequest
     */
    public function addToUserDataGUIProperty(\Pggns\MidocoApi\Bank\StructType\UserDataGUIProperty $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\UserDataGUIProperty) {
            throw new InvalidArgumentException(sprintf('The UserDataGUIProperty property can only contain items of type \Pggns\MidocoApi\Bank\StructType\UserDataGUIProperty, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
