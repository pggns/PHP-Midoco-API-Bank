...
class ImportHandlerResponseType extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Bank\StructType\ImportHandlerResponseMessage[]
     */
     ...
     * @param string $result
     * @param string $error
     * @param \Pggns\MidocoApi\Bank\StructType\ImportHandlerResponseMessage[] $importHandlerResponseMessage
     */
     ...
     * @return \Pggns\MidocoApi\Bank\StructType\ImportHandlerResponseMessage[]
     */
    ...
    public static function validateImportHandlerResponseMessageForArrayConstraintFromSetImportHandlerResponseMessage(?array $values = []): string
    {
        ...
        foreach ($values as $importHandlerResponseTypeImportHandlerResponseMessageItem) {
            ...
            if (!$importHandlerResponseTypeImportHandlerResponseMessageItem instanceof \Pggns\MidocoApi\Bank\StructType\ImportHandlerResponseMessage) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ImportHandlerResponseMessage property can only contain items of type \Pggns\MidocoApi\Bank\StructType\ImportHandlerResponseMessage, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Bank\StructType\ImportHandlerResponseMessage $item
     * @return \Pggns\MidocoApi\Bank\StructType\ImportHandlerResponseType
     */
    public function addToImportHandlerResponseMessage(\Pggns\MidocoApi\Bank\StructType\ImportHandlerResponseMessage $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Bank\StructType\ImportHandlerResponseMessage) {
            throw new InvalidArgumentException(sprintf('The ImportHandlerResponseMessage property can only contain items of type \Pggns\MidocoApi\Bank\StructType\ImportHandlerResponseMessage, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
