...
class CollectiveInvoicePrintOrderDetails extends AbstractStructBase
{
     ...
     */
    public function __construct(array $sellItemDetails4Printing = [], ?\Pggns\MidocoApi\Bank\StructType\MidocoOrderType $midocoOrder = null, ?\Pggns\MidocoApi\Bank\StructType\MidocoInvoice $midocoInvoice = null)
    {
        $this
