...
class MidocoTravelItemType extends TravelitemDTO
{
     ...
     */
    public function __construct(array $midocoCarDetail = [], array $midocoAccomodationDetail = [], array $midocoFlightDetail = [], array $midocoInsuranceDetail = [], array $midocoTravelDetail = [], ?\Pggns\MidocoApi\Bank\StructType\TravelSupplierInfoDTO $midocoTravelSupplierInfo = null, array $midocoHint = [], array $midocoCruiseDetail = [], array $midocoLeisureMixedDetail = [], array $midocoBusDetail = [], array $midocoRailDetail = [], array $midocoAdditionalService = [], array $midocoEventDetail = [], array $midocoTransferDetail = [], array $midocoTouchedCountry = [])
    {
        $this
